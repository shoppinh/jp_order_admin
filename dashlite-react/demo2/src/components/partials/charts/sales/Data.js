  ...
  datasets: [
    {
      ...
      color: 'rgba(133, 79, 255, 0.25)',
      fill: true,
      backgroundColor: 'rgba(133, 79, 255, 0.25)',
      borderColor: 'rgba(133, 79, 255, 1)',
      barPercentage: 0.1,
      ...
      pointHoverBorderColor: 'rgba(133, 79, 255, 1)',
      pointHoverBackgroundColor: '#fff',
      data: [
        8200, 7800, 9500, 5500, 9200, 9690, 8200, 7800, 9500, 5500, 9200, 9690, 8200, 7800, 9500,
        5500, 9200, 9690, 8200, 7800, 9500, 5500, 9200, 9690, 8200, 7800, 9500, 5500, 9200, 9690,
      ],
    },
  ],
};
  ...
  datasets: [
    {
      ...
      categoryPercentage: 0.6,
      data: [
        1780, 2300, 2820, 2200, 2600, 1500, 1620, 1300, 1500, 1720, 1200, 1500, 2030, 2100, 1780,
        2300, 2820, 2200, 2600, 1500, 1620, 1300, 1500, 1720, 1200, 1500, 2030, 2100, 3200, 3200,
      ],
    },
    {
      label: 'Sell Orders',
      ...
      categoryPercentage: 0.6,
      data: [
        2520, 1320, 2000, 3000, 2750, 1920, 2900, 4000, 3400, 2900, 4500, 2680, 2520, 1900, 2520,
        1320, 2000, 3000, 2750, 1920, 2900, 4000, 3400, 2900, 4500, 2680, 2520, 1900, 2500, 2500,
      ],
    },
  ],
};
...
export const userActivity = {
  ...
  datasets: [
    ...
    },
    {
      ...
      data: [
        125, 55, 95, 75, 90, 110, 80, 125, 55, 95, 75, 90, 110, 80, 125, 55, 95, 75, 90, 75, 90,
      ],
      categoryPercentage: 0.7,
      barPercentage: 0.7,
    },
  ...
  datasets: [
    {
      ...
      backgroundColor: '#9cabff',
      data: [
        90, 70, 125, 80, 95, 15, 90, 110, 80, 125, 55, 95, 155, 90, 120, 80, 105, 75, 85, 55, 100,
      ],
      categoryPercentage: 0.7,
      barPercentage: 0.7,
    },
    {
      ...
      backgroundColor: 'rgba(156, 171, 255, 0.4)',
      data: [
        105, 35, 100, 55, 40, 120, 70, 105, 59, 90, 70, 90, 100, 18, 105, 59, 105, 65, 50, 55, 80,
      ],
      categoryPercentage: 0.7,
      barPercentage: 0.7,
    },
  ...
  datasets: [
    {
      ...
      backgroundColor: '#9cabff',
      data: [
        90, 180, 25, 85, 85, 75, 90, 50, 90, 25, 55, 155, 70, 90, 110, 80, 125, 55, 95, 85, 100,
      ],
      categoryPercentage: 0.7,
      barPercentage: 0.7,
    },
    {
      ...
      backgroundColor: 'rgba(156, 171, 255, 0.4)',
      data: [
        125, 65, 65, 95, 100, 90, 70, 25, 155, 65, 75, 80, 10, 90, 135, 56, 95, 75, 98, 79, 110,
      ],
      categoryPercentage: 0.7,
      barPercentage: 0.7,
    },
