        ...
        <div className='content-page wide-md m-auto'>
          <BlockHead size='lg' wide='xs' className='mx-auto'>
            <BlockHeadContent className='text-center'>
              ...
              <BlockDes>
                <p className='lead'>
                  We are on a mission to make the web a better place. The following terms, as well
                  as our Policy and Terms of Service, apply to all users.
                </p>
            ...
            <PreviewCard className='card-bordered'>
              <div className='entry'>
                ...
                <p>
                  ...
                  <strong>Creative Commons</strong> license. You can grab a copy of these Terms and
                  other legal documents on Github. You’re more than welcome to copy them, adapt
                  them, and repurpose them for your own use.
                </p>
                <h4>Introduction</h4>
                <p>
                  These Website Standard Terms and Conditions written on this webpage shall manage
                  your use of our website, Webiste Name accessible at Website.com.
                </p>
                <p>
                ...
                <ul className='list list-sm list-checked'>
                  ...
                  <li>
                    ...
                    Company Name may further restrict access by you to any areas of this Website, at
                ...
                <p>
                  ...
                  By displaying Your Content, you grant Company Name a non-exclusive, worldwide
                ...
                <p>
                  ...
                  Company Name reserves the right to remove any of Your Content from this Website at
                ...
                <p>
                  ...
                  shall be held liable for anything arising out of or in any way connected with your
                  use of this Website whether such liability is under contract. Company Name,
                  including its officers, directors and employees shall not be held liable for any
                  indirect, consequential or special liability arising out of or in any way related
                ...
                <p>
                  Company Name is permitted to revise these Terms at any time as it sees fit, and by
                  using this Website you are expected to review these Terms on a regular basis.
                </p>
                <h4>Assignment</h4>
                <p>
                  The Company Name is allowed to assign, transfer, and subcontract its rights and/or
                ...
                <p>
                  ...
                  State of Country, and you submit to the non-exclusive jurisdiction of the state
