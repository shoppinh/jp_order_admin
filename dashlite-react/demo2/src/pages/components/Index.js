      ...
      <Content page='component'>
        <BlockHead size='lg' className='wide-sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                <strong>DashLite</strong> includes all the necessary components and elements with
                utility classes that helps you to create your web apps or application faster.
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
