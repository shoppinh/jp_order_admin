      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                Convey meaning through color with a handful of color utility classNames. This
                utilities to quickly style the text and background of any element.
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className='code-class'>.bg-[color]</code> className in element to set
                background color.
              </p>
            </BlockHeadContent>
          </BlockHead>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className='code-class'>.bg-gray-[value]</code> className in element to set
                background color.
              </p>
            </BlockHeadContent>
          </BlockHead>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className='code-class'>.text-{'{theme|color}'}</code> className in element to
                set text color.
              </p>
            </BlockHeadContent>
          </BlockHead>
