          ...
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                ...
                available and flexible alert messages. To use it, import it such as{' '}
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Alerts are available for any length of text. Use <code> {`Alert`}</code> component
                with <code>color</code> props to create alert messages.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
            <div className='gy-4'>
              <div>
                <Alert className='alert-icon' color='primary'>
                  ...
                  <strong>Order has been placed</strong>. You will be redirected to complete your
                  payment.
                </Alert>
              </div>
              <div>
              ...
              <div>
                <Alert className='alert-icon' color='success'>
                  ...
                  <strong>Thanks for your deposit</strong>. Your account balance has been updated
                  accordingly.
                </Alert>
              </div>
              <div>
              ...
              <div>
                <Alert className='alert-icon' color='warning'>
                  <Icon name='alert-circle' />
                  Your credit card <strong>already expired</strong>. Please enter a valid &amp;
                  up-to-date{' '}
              ...
              <div>
                <Alert className='alert-icon' color='info'>
                  <Icon name='alert-circle' />
                  <strong>Order has been placed</strong>. Your will be redirected to complete your
                  payment.
                </Alert>
              </div>
              <div>
              ...
              <div className='example-alert'>
                <Alert className='alert-pro' color='primary'>
                  <div className='alert-text'>
                    ...
                    <p>
                      Your order has been successfully placed for deposit. You will be redirected to
                      payment portal.{' '}
                    </p>
                  </div>
                </Alert>
              ...
              <div className='example-alert'>
                <Alert className='alert-pro' color='success'>
                  <div className='alert-text'>
                    ...
                    <p>
                      Thanks for your deposit. Now you can see your transaction history. Your
              ...
              <div className='example-alert'>
                <Alert className='alert-pro' color='warning'>
                  <div className='alert-text'>
                    ...
                    <p>
                      Sorry! your credit card already expired. Please enter a valid &amp; up-to-date
                      credit card to deposit your money.
                    </p>
                  </div>
                </Alert>
              </div>
