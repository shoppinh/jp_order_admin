      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                Documentation and examples of button styles for actions in forms, dialogs and more
                with support for multiple sizes, states, and more. To use it, import it such as{' '}
