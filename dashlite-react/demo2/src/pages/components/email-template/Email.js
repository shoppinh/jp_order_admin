      ...
      <Content page='component'>
        <BlockHead>
          <BlockContent>
            ...
            <BlockDes>
              <p className='lead'>
                In DashLite, We included 10 clean and minimalist notification email templates that
                is ready to use for your application to send emails.{' '}
            ...
            <EmailWrapper>
              ...
              <EmailBody>
                <EmailBodyContent className='p-3 p-sm-5'>
                  ...
                  <p>
                    Let's face it, sometimes you have a simple message that doesn’t need much
                    design—but still needs flexibility and reliability. Select a basic email
                    template. Write your message. Then send with confidence.
                  </p>
                  <p>
                    Its clean, minimal and pre-designed email template that is suitable for multiple
                    purposes email template.
                  </p>
                  <p>
                    Hope you'll enjoy the experience, we're here if you have any questions, drop us
                    a line at info@yourwebsite.com anytime.{' '}
                  </p>
                  <p className='mt-4'>
                    ---- <br /> Regards
                    <br />
              ...
              <EmailFooter>
                ...
                <p className='fs-12px pt-4'>
                  ...
                  <a href='https://softnio.com'>softnio.com</a>. To update your emails preferences{' '}
                  <a
                    href='#click'
                    onClick={(ev) => {
                      ev.preventDefault();
              ...
              <EmailBody centered>
                <EmailBodyContent className='p-3 p-sm-5'>
                  ...
                  <p className='fs-16px text-base'>
                    Say hello to version 1.1. Introducing email template with massaging application
                    concept and as always modern, clean and easier to use.
                  </p>
                  <p>
                    Hope you'll enjoy the experience, we're here if you have any questions, drop us
                    a line at info@yourwebsite.com anytime.{' '}
            ...
            <EmailWrapper>
              ...
              <EmailBody>
                ...
                <EmailBodyContent className='px-3 px-sm-5 pb-2'>
                  <p>Hi Ishtiyak,</p>
                  <p>
                    Welcome! <br /> You are receiving this email because you have registered on our
                    site.
                  </p>
                ...
                <EmailBodyContent className='px-3 px-sm-5 pt-4 pb-3 pb-sm-5'>
                  ...
                  <p className='email-note'>
                    This is an automatically generated email please do not reply to this email. If
                    you face any issues, please contact us at help@dashlite.com
                  </p>
                </EmailBodyContent>
              </EmailBody>
              <EmailFooter>
            ...
            <EmailWrapper>
              ...
              <EmailBody>
                <EmailBodyContent className='p-3 p-sm-5'>
                  ...
                  <p>
                    Your account is now verified and you can purchase tokens for the ICO. Also you
                    can submit your documents for the KYC from my Account page.
                  </p>
                  <p>
                    Hope you'll enjoy the experience, we're here if you have any questions, drop us
                    a line at <a href='mailto:info@yourwebsite.com'>info@yourwebsite.com</a>{' '}
                    anytime.{' '}
                  </p>
                </EmailBodyContent>
              </EmailBody>
            ...
            <EmailWrapper>
              ...
              <EmailBody centered>
                ...
                <EmailBodyContent className='px-3 px-sm-5 pb-3 pb-sm-5'>
                  ...
                  <p>
                    We are still working on your identity verification. Once our team verified your
                    indentity, you will be whitelisted and notified by email.
                  </p>
                </EmailBodyContent>
              </EmailBody>
              <EmailFooter>
            ...
            <EmailWrapper>
              ...
              <EmailBody centered>
                ...
                <EmailBodyContent className='px-3 px-sm-5 pb-3 pb-sm-5'>
                  ...
                  <p>
                    In our verification process, we found information are missing. It would great if
                    you resubmit the form. If face problem in submission please contact us with our
                    best ever excelent support team.
                  </p>
                </EmailBodyContent>
              </EmailBody>
              <EmailFooter>
            ...
            <EmailWrapper>
              ...
              <EmailBody centered>
                ...
                <EmailBodyContent className='px-3 px-sm-5 pb-3 pb-sm-5'>
                  ...
                  <p>
                    One fo our team verified your indentity. You are now in whitelisted for token
                    sale.
                  </p>
                </EmailBodyContent>
              </EmailBody>
              ...
              <EmailBody>
                ...
                <EmailBodyContent className='text-center px-3 px-sm-5 pb-5'>
                  ...
                  <p className='mgb-1-5x'>
                    Lorem Ipsum decided to leave for the far World of Grammar. The Big Oxmox advised
                    her not to do so, because there were thousands of bad Comma
                  </p>
                  <a
                    href='#readmore'
                    onClick={(ev) => {
                ...
                <EmailBodyContent className='text-center px-3 px-sm-5 pb-5'>
                  ...
                  <p>
                    Lorem Ipsum decided to leave for the far World of Grammar. The Big Oxmox advised
                    her not to do so, because there were thousands of bad Commans.
                  </p>
                </EmailBodyContent>
                <EmailBodyContent className='text-center px-3 px-sm-5 pb-4'>
