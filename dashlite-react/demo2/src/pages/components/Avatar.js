        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Add any of the below props to the <code>UserAvatar</code> components to change the
                appearance of a avatar.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  <code>
                    primary, secondary, warning, danger, success, info, azure, blue, pink, indigo,
                    dark, gray, orange, teal, purple, lighter
                  </code>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <code>
                    primary, secondary, warning, danger, success, info, azure, blue, pink, indigo,
                    dark, gray, orange, teal, purple, light
                  </code>{' '}
