        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Apply <code className='language-plaintext highlighter-rouge'>display</code>{' '}
                utilities to create a flexbox container and transform{' '}
                <strong>direct children elements</strong> into flex items. Flex containers and items
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className='highlighter-rouge'>row</code>. If you want to change direction then
                use <code className='highlighter-rouge'>flex-row</code> for horizontal direction,{' '}
                <code className='highlighter-rouge'>flex-row-reverse</code> for opposite horizontal
                direction. Default Vertical direction is{' '}
                <code className='highlighter-rouge'>column</code>,for it use{' '}
                <code className='highlighter-rouge'>flex-column</code> or{' '}
                <code className='highlighter-rouge'>flex-column-reverse</code> for opposit vertical
                direction
              </p>
            </BlockHeadContent>
          </BlockHead>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                On flexbox container use <code className='highlighter-rouge'>justify-content</code>{' '}
                utilities for change the alignment of flex items. There are many classNames. just
                add <code className='highlighter-rouge'>(start, end, center, between, around)</code>{' '}
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                On flexbox container use <code className='highlighter-rouge'>align-items</code>{' '}
                utilities for change the alignment of flex items on the cross axis. There are many
                classNames. just add{' '}
                <code className='highlighter-rouge'>(start, end, center, baseline, stretch)</code>{' '}
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                On flexbox items use <code className='highlighter-rouge'>align-self</code> utilities
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Use <code className='highlighter-rouge'>.flex-grow-*</code> utilities to toggle a
                flex item’s ability to grow to fill available space. In the example below, the{' '}
                <code className='highlighter-rouge'>.flex-grow-1</code> elements uses all available
                space it can, while allowing the remaining two flex items their necessary space.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className='highlighter-rouge'>.ms-auto</code>,{' '}
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                browser default) with <code className='highlighter-rouge'>.flex-nowrap</code>,
                wrapping with <code className='highlighter-rouge'>.flex-wrap</code>, or reverse
                wrapping with <code className='highlighter-rouge'>.flex-wrap-reverse.</code>.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className='highlighter-rouge'>order</code> utilities. We only provide options
                for making an item first or last, as well as a reset to use the DOM order.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Use align-content utilities on flexbox containers to align flex items together on
                the cross axis. Choose from start (browser default), end, center, between, around,
                or stretch. To demonstrate these utilities, we’ve enforced{' '}
