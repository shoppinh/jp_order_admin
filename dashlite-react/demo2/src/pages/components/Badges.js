      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                Documentation and examples for badges, our small count and labeling component. To
                use it, import it such as <code>import {`{Badge}`} from "reactstrap"</code>. Visit
                the{' '}
                <a
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Use the <code>.badge-dim</code> modifier className to make soft light / pale color
                badges.
              </p>
            </BlockHeadContent>
          </BlockHead>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag='h5'>Example with Variations</BlockTitle>
              <p>
                Add any of the below mentioned modifier classNames to change the appearance of a
                badge.
              </p>
            </BlockHeadContent>
          </BlockHead>
