      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                Examples for using custom progress bars featuring support for stacked bars, animated
                backgrounds, and text labels. To use it, import it such as{' '}
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Use the <code>value</code> props in <code>Progress</code> element to indicate
                progress status.
              </p>
            </BlockHeadContent>
          </BlockHead>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Use background utility classNames to change the appearance of individual progress
                bars.
              </p>
            </BlockHeadContent>
          </BlockHead>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Add <code>striped</code> props to any <code>Progress</code> component to apply a
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                The striped gradient can also be animated. Add <code>animated</code> props to{' '}
                <code>Progress</code> to animate the stripes right to left via CSS3 animations.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
