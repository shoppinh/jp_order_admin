            ...
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>
                  ...
                  <code>ul.custom-control-group &gt; li &gt; .custom-control</code> if you want
                  vertical them use <code>.custom-control-vertical</code> on <code>ul</code>.
                </p>
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>
                  You can create checkbox or radio with any styled element, just like displayed
                  below. just add <code>.custom-control-pro</code> class with{' '}
                  <code>.custom-control</code> then put that styled element in{' '}
                  <code className='code-tag'>&lt;label&gt;</code> tag. An example with user card
                  shown for display purpose. <br />{' '}
