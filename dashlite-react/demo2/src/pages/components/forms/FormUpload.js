      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                Examples and usage guidelines for form upload fields with default file input type
                and with{' '}
          ...
          <PreviewTable>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  Use <code>{`{number}`}</code> with <code>maxFiles</code> props to specify file
                  limit in react dropzone{' '}
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  Use <code>{`{size}`}</code> with <code>maxSize</code> props to specify file size
                  (bytes) limit in react dropzone{' '}
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  ...
                  <code>image/*, .docx, .psd, .txt</code> etc in a array of strings to specify
                  accepted file types.
                </td>
              </tr>
            </tbody>
