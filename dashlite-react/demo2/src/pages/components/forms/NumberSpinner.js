      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                Examples and usage guidelines for number spinner with basic number type input.
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
          ...
          <PreviewTable>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  Use <code>{`{number}`}</code> with <code>max</code> props to specify the max limit
                  for the input.
                </td>
              </tr>
              <tr>
                ...
                <td>
                  Use <code>{`{number}`}</code> with <code>min</code> props to specify the min limit
                  for the input.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  Use <code>{`{boolean}`}</code> with <code>outline</code> props to specify if
                  outline on button is needed.
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  Use <code>{`{color}`}</code> with <code>color</code> props to specify the color of
                  the button.
                </td>
              </tr>
              <tr>
                ...
                <td>
                  Use <code>{`{number}`}</code> with <code>defaultVal</code> props to specify any
