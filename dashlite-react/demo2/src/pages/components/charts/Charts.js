      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                <a href='https://www.chartjs.org/'>ChartJs</a> is a very simple and flexible
                JavaScript charting for designers & developers. You can visualize your data in
                different ways. We present some of examples for you.
              </p>
              <p>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>
                  Alternatively, you can use line chart with some background to display more
                  visually.
                </p>
              </BlockDes>
            </BlockHeadContent>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>
                  A bar chart provides a way of comparison of multiple data sets side by side or
                  with stacked view.
                </p>
              </BlockDes>
            </BlockHeadContent>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>
                  Pie and doughnut charts are probably the most commonly used charts. It use to show
