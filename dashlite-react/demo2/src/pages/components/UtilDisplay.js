          ...
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                ...
                display utilities. ClassNames can be combined for various effects as you need.
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
          ...
          <PreviewTable>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  Use <code>{'{breakpoint}'}</code> as <code>sm, md, lg, and xl</code> to effect on
                  screen width.
                </td>
              </tr>
              <tr>
                <td colSpan='2'>
                  <em className='fs-13px'>
                    ...
                    example, <code>.d-lg-none</code> sets{' '}
                    <code className='code-fnc'>display: none;</code> on both <code>lg</code> and{' '}
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                For faster mobile-friendly development, use responsive display classNames for
                showing and hiding elements by device.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewTable>
