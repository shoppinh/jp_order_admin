          ...
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                ...
                super-power them with JavaScript. To use it, import it such as{' '}
                <code>import {`{ButtonGroup}`} from "reactstrap"</code>. Visit the{' '}
                <a
                  href={
                    'https://reactstrap.github.io/?path=/docs/components-buttongroup--button-group'
                  }
                  target='_blank'
                  rel='noreferrer'
                >
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Just add <code>size</code> to each <code>ButtonGroup</code> component to control
                applying button sizing globaly.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
