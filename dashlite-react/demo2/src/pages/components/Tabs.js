      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                Use the Reactstrap tab component, tabs and pills to create tabbable panes of local
                content, even via dropdown menus. To use it, import it such as{' '}
                <code>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                You can simply activate a tab or pill navigation, add <code>tabs</code> or{' '}
                <code>pills</code> props to <code>Nav</code> component. Here is some basic tab
                component that you can use. Visit the{' '}
                <a
            ...
            <TabContent activeTab={activeTab}>
              <TabPane tabId='1'>
                <p>
                  ...
                  Veniam sint duis incididunt do esse magna mollit excepteur laborum qui. Id id
                  reprehenderit sit est eu aliqua occaecat quis et velit excepteur laborum mollit
                  dolore eiusmod. Ipsum dolor in occaecat commodo et voluptate minim reprehenderit
              ...
              <TabPane tabId='2'>
                <p>
                  ...
                  consectetur adipisicing officia excepteur non sit. Ut et elit aliquip labore Lorem
                  enim eu. Ullamco mollit occaecat dolore ipsum id officia mollit qui esse anim
                  eiusmod do sint minim consectetur qui.
                </p>
              </TabPane>
              <TabPane tabId='3'>
                <p>
                  Fugiat id quis dolor culpa eiusmod anim velit excepteur proident dolor aute qui
                  magna. Ad proident laboris ullamco esse anim Lorem Lorem veniam quis Lorem irure
                  occaecat velit nostrud magna nulla. Velit et et proident Lorem do ea tempor
                  officia dolor. Reprehenderit Lorem aliquip labore est magna commodo est ea veniam
                  consectetur.
                </p>
              </TabPane>
              <TabPane tabId='4'>
                <p>
                  ...
                  elit id dolor proident in cupidatat officia. Voluptate excepteur commodo labore
                  nisi cillum duis aliqua do. Aliqua amet qui mollit consectetur nulla mollit velit
                  aliqua veniam nisi id do Lorem deserunt amet. Culpa ullamco sit adipisicing labore
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                You can simply activate add <code>.nav-tabs-s2</code> className in <code>Nav</code>{' '}
                component to make an alternet styled tab.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
                ...
                <TabContent activeTab={verticalTab}>
                  <TabPane tabId='1'>
                    <p>
                      ...
                      Id id reprehenderit sit est eu aliqua occaecat quis et velit excepteur laborum
                      mollit dolore eiusmod. Ipsum dolor in occaecat commodo et voluptate minim
                      reprehenderit mollit pariatur. Deserunt non laborum enim et cillum eu deserunt
                      excepteur ea incid.
                    </p>
                    <p>
                      Cillum ad ut irure tempor velit nostrud occaecat ullamco aliqua anim Lorem
                  ...
                  <TabPane tabId='2'>
                    <p>
                      ...
                      dolor deserunt commodo et minim in quis laboris ipsum velit id veniam. Quis ut
                  ...
                  <TabPane tabId='3'>
                    <p>
                      Fugiat id quis dolor culpa eiusmod anim velit excepteur proident dolor aute
                      qui magna. Ad proident laboris ullamco esse anim Lorem Lorem veniam quis Lorem
                      irure occaecat velit nostrud magna nulla. Velit et et proident Lorem do ea
                      tempor officia dolor. Reprehenderit Lorem aliquip labore est magna commodo est
