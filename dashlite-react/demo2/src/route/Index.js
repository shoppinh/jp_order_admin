...
import {RoleBaseProtectedRoute} from './RoleBasedProtectedRoute';
    ...
    return (
        <Routes>
            <Route path={`${process.env.PUBLIC_URL}`} element={<Layout/>}>
                ...
                <Route
                    ...
                    element={
                        <RoleBaseProtectedRoute
                            ...
                            unAuthorizedRedirectTo={SiteMap.home.link}
                        >
                            <EcomOrder/>
                        </RoleBaseProtectedRoute>
                    }
                />
                <Route path='products' element={<ProtectedRoute unAuthenticatedRedirectTo={SiteMap.login.link}>
                    <EcomProducts/>
                </ProtectedRoute>}/>
                <Route path='support' element={<ProtectedRoute unAuthenticatedRedirectTo={SiteMap.login.link}>
                    <EcomSupport/>
                </ProtectedRoute>}/>
                <Route path='invoice-list' element={<RoleBaseProtectedRoute
                    roles={DefaultRole}
                    unAuthenticatedRedirectTo={SiteMap.login.link}
                    unAuthorizedRedirectTo={SiteMap.home.link}
                >
                ...
                <Route path='invoice-details/:invoiceId' element={<RoleBaseProtectedRoute
                    roles={DefaultRole}
                    unAuthenticatedRedirectTo={SiteMap.login.link}
                    unAuthorizedRedirectTo={SiteMap.home.link}
                >
                ...
                <Route path='settings' element={<ProtectedRoute unAuthenticatedRedirectTo={SiteMap.login.link}>
                    <EcomSettings/>
                </ProtectedRoute>}/>
                {/*<Route path='integration' element={<EcomIntegration/>}></Route>*/}
                <Route element={<CustomerProvider/>}>
                    <Route path='customer' element={<EcomCustomer/>}/>
                    <Route path='customer-details/:customerId' element={<EcomCustomerDetails/>}/>
                </Route>
                {/*Pre-built Pages*/}
                <Route path='project-card' element={<ProjectCardPage/>}/>
                <Route path='project-list' element={<ProjectListPage/>}/>
                <Route element={<UserContextProvider/>}>
                    <Route path='user-list-default' element={<UserListDefault/>}/>
                    <Route path='user-list-regular' element={<UserListRegular/>}/>
                    <Route path='user-list-compact' element={<UserListCompact/>}/>
                    <Route path='user-contact-card' element={<UserContactCard/>}/>
                    <Route path='user-details-regular/:userId' element={<UserDetails/>}/>
                </Route>
                <Route>
                    <Route path='user-profile-notification'
                           element={<ProtectedRoute unAuthenticatedRedirectTo={SiteMap.login.link}>
                               <UserProfileNotification/>
                           </ProtectedRoute>}/>
                    <Route path='user-profile-regular'
                           element={<ProtectedRoute unAuthenticatedRedirectTo={SiteMap.login.link}>
                               <UserProfileRegular/>
                           </ProtectedRoute>}/>
                ...
                <Route path='order-list-default' element={<RoleBaseProtectedRoute
                    roles={DefaultRole}
                    unAuthenticatedRedirectTo={SiteMap.login.link}
                    unAuthorizedRedirectTo={SiteMap.home.link}
                >
                    <OrderDefault/>
                </RoleBaseProtectedRoute>}></Route>
                <Route path='order-list-regular' element={<RoleBaseProtectedRoute
                    roles={DefaultRole}
                    unAuthenticatedRedirectTo={SiteMap.login.link}
                    unAuthorizedRedirectTo={SiteMap.home.link}
                >
                ...
                <Route path='order-list-sales' element={<RoleBaseProtectedRoute
                    roles={DefaultRole}
                    unAuthenticatedRedirectTo={SiteMap.login.link}
                    unAuthorizedRedirectTo={SiteMap.home.link}
                >
                ...
                <Route path='kyc-list-regular' element={<KycListRegular/>}/>
                <Route path='kyc-details-regular/:kycId' element={<KycDetailsRegular/>}/>
                <Route element={<RoleBaseProtectedRoute
                    roles={DefaultRole}
                    unAuthenticatedRedirectTo={SiteMap.login.link}
                    unAuthorizedRedirectTo={SiteMap.home.link}
                >
                ...
                <Route path='image-gallery' element={<GalleryPreview/>}/>
                <Route path='pages'>
            ...
            <Route path={`${process.env.PUBLIC_URL}`} element={<LayoutNoSidebar/>}>
                ...
                <Route path={SiteMap.register.link} element={<Register/>}></Route>
                <Route path={SiteMap.login.link} element={<Login/>}></Route>
                <Route path={SiteMap.landing.link} element={<PricingTable/>}></Route>
                <Route path='errors'>
