...
import {Button, Block, BlockBetween, BlockHead, BlockHeadContent, BlockTitle, BlockDes, Col, Icon, Row } from "../../../components/Component";
...
const InvoiceDetails = () => {
  ...
  return (
    <React.Fragment>
      ...
      {user && (<Content>
        <BlockHead size="lg">
          <div className="nk-block-head-sub"><Link className="back-to" to={`${process.env.PUBLIC_URL}/subscription/invoices`}><Icon name="arrow-left"/><span>Invoices</span></Link></div>
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle tag="h2" className="fw-normal">Invoice #{user.orderId}</BlockTitle>
              <BlockDes>
