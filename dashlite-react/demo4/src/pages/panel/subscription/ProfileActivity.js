...
const ProfileActivity = () => {
  return (
    <React.Fragment>
      ...
      <Content>
        <BlockHead size="md">
          <div className="nk-block-head-sub"><Link className="back-to" to={`${process.env.PUBLIC_URL}/subscription/profile`}><Icon name="arrow-left"/><span>My Profile</span></Link></div>
          <BlockBetween>
            <BlockHeadContent>
