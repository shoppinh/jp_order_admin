                ...
                <BlockHeadContent>
                    <ul className="nk-block-tools gx-3">
                        <li className="order-md-last">
                            <Link to={`${process.env.PUBLIC_URL}/subscription/pricing`} className="btn btn-white btn-dim btn-outline-primary"><span>View Pricing</span></Link>
                        </li>
                    </ul>
                </BlockHeadContent>
            </BlockBetween>
                        ...
                        <Row className="gx-0 gy-3">
                            <Col xl="9" sm="8">
                                <div className="sp-plan-name">
                                    <h6 className="title"><Link to={`${process.env.PUBLIC_URL}/subscription/subscription-details/${item.id}`}>{item.title} <Badge color={item.status == 'Active' ? 'success' : 'light'} className="rounded-pill">{item.status}</Badge></Link></h6>
