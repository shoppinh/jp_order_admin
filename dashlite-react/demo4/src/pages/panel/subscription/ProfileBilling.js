              ...
              <div className="card-inner">
                  <div className="between-center flex-wrap flex-md-nowrap g-3">
                      ...
                      <div className="nk-block-actions flex-shrink-0">
                          <Link to={`${process.env.PUBLIC_URL}/subscription/pricing`} className="btn btn-primary">Change Plan</Link>
                      </div>
                  </div>
              </div>
              <div className="card-inner">
                  <div className="between-center flex-wrap flex-md-nowrap g-3">
                      <div className="nk-block-text">
                          <p>Learn more about our <Link to={`${process.env.PUBLIC_URL}/subscription/pricing`}>subscription options</Link>.</p>
                      </div>
