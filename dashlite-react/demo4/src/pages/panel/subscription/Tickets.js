                  ...
                  {ticketData.map((item,index)=> {
                    ...
                    return(
                      <tr key={index} className={`tb-ticket-item${item.unread && ' is-unread'}`}>
                        <td className="tb-ticket-id"><Link to={`${process.env.PUBLIC_URL}/subscription/ticket-details/${item.id}`}>{item.id}</Link></td>
                        <td className="tb-ticket-desc">
                            <Link to={`${process.env.PUBLIC_URL}/subscription/ticket-details/${item.id}`}><span className="title">{item.subject}</span></Link>
                        </td>
                        ...
                        <td className="tb-ticket-action">
                            <Link to={`${process.env.PUBLIC_URL}/subscription/ticket-details/${item.id}`} className="btn btn-icon btn-trigger">
            ...
            <div className="card-inner">
                <div className="nk-cta">
                    ...
                    <div className="nk-cta-action">
                        <Link to={`${process.env.PUBLIC_URL}/subscription/contact`} className="btn btn-primary">Contact Us</Link>
                    </div>
                </div>
            </div>
          </Card>
