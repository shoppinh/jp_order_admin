                ...
                <div className="card-inner">
                    <div className="between-center flex-wrap flex-md-nowrap g-3">
                        ...
                        <div className="nk-block-actions flex-shrink-0">
                            <Link to={`${process.env.PUBLIC_URL}/subscription/subscription-details/${subscription.id}`} className="btn btn-primary">View Plan</Link>
                        </div>
                    </div>
                </div>
                <div className="card-inner">
                    <div className="between-center flex-wrap flex-md-nowrap g-3">
                        <div className="nk-block-text">
                            <p>Learn more about our <Link to={`${process.env.PUBLIC_URL}/subscription/subscriptions`}>subscription options</Link>.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="card-inner card-inner-md">
                <div className="card-title-group">
                    ...
                    <div className="card-action">
                        <Link to={`${process.env.PUBLIC_URL}/subscription/payments`} className="link link-sm">See All <em className="icon ni ni-chevron-right"></em></Link>
                    </div>
                </div>
            </div>
