      ...
      {question && (<Content>
        <BlockHead size="lg">
          <div className="nk-block-head-sub">
            <Link className="back-to" to={`${process.env.PUBLIC_URL}/subscription/support/${topic.slug}`}>
        ...
        <Block>
          ...
          {nextQuestion && 
            <div className="support-topic-more card card-bordered">
              <Link className="support-topic-block card-inner" to={`${process.env.PUBLIC_URL}/subscription/support/${nextTopic.slug}/${nextQuestion.id}`}>
