...
const TicketDetails = () => {
  ...
  return (
    <React.Fragment>
      ...
      {ticket && (<Content>
        <BlockHead>
          <div className="nk-block-head-sub"><Link className="back-to" to={`${process.env.PUBLIC_URL}/subscription/tickets`}><Icon name="arrow-left"/><span>My Tickets</span></Link></div>
          <BlockBetween>
            <BlockHeadContent>
