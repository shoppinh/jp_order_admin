...
const ProfileConnected = () => {
  return (
    <React.Fragment>
      <Head title="Profile Connected"></Head>
        ...
        <div className="between-center flex-wrap flex-md-nowrap g-3">
          <div className="media media-center gx-3 wide-xs">
            ...
            <div className="media-content">
              <p>
                You have successfully connected with your facebook account, you can easily log in using your account too
              </p>
            </div>
          </div>
      ...
      <PreviewAltCard>
        <div className="between-center flex-wrap flex-md-nowrap g-3">
          <div className="media media-center gx-3 wide-xs">
            ...
            <div className="media-content">
              <p>
                You can connect with your google account. <em className="d-block text-soft">Not connected yet</em>
              </p>
            </div>
          </div>
          <div className="nk-block-actions flex-shrink-0">
