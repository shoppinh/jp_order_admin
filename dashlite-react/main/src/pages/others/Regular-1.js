      ...
      <Content>
        <BlockHead size='lg' wide='xs' className='mx-auto'>
          <BlockHeadContent className='text-center'>
            ...
            <BlockDes>
              <p className='lead'>
                We love to share ideas! Visit our blog if you're looking for great articles or
        ...
        <Block>
          <PreviewCard bodyClass='card-inner-xl'>
            <article className='entry'>
              ...
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga eius ipsam blanditiis
                voluptatem mollitia dolores asperiores ipsum rerum repellendus. Ullam et, quam eos
                blanditiis ipsum tempore minus quis laborum praesentium.
              </p>
              <p>
                Popsam blanditiis voluptatem mollitia dolores asperiores ipsum rerum repellendus.
                Ullam et, quam eos blanditiis ipsum tempore.
              </p>
              <img src={RegularImage} alt='' />
              <h4>Mollitia dolores asperiores ipsum rerum repellendus</h4>
              <p>
                Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illoveritatis et quasi
              ...
              <p>
                Mollitia dolores asperiores ipsum rerum repellendus Sed ut accusantium doloremque
