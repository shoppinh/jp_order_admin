    ...
    <div className='card-inner-group'>
      <div className='card-inner'>
        <div className='user-card'>
          <UserAvatar text={findUpper(profileData?.fullName)} theme='primary' />
          <div className='user-info'>
            <span className='lead-text'>{profileData?.fullName}</span>
      ...
      <div className='card-inner'>
        <div className='user-account-info py-0'>
          <h6 className='overline-title-alt'>No Wallet Account</h6>
          <div className='user-balance'>
            {profileData?.balance} <small className='currency currency-btc'>VND</small>
          </div>
        ...
        <ul className='link-list-menu'>
          ...
          <li onClick={() => updateSm(false)}>
            <Link
              ...
              className={
                window.location.pathname === `${process.env.PUBLIC_URL}/user-profile-activity`
                  ? 'active'
                  : ''
              }
            >
          ...
          <li onClick={() => updateSm(false)}>
            <Link
              ...
              className={
                window.location.pathname === `${process.env.PUBLIC_URL}/user-profile-setting`
                  ? 'active'
                  : ''
              }
            >
