      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                Dual Listbox is a pure JavaScript plugin that converts the normal select box into a
                searchable dual list box where the users are able to move options between two
                selection panels. Visit the{' '}
                <a
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                Add an <code>icons</code> props to the <code>DualList component</code> to add custom
                buttons.
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                Add an <code>selected</code> props to the <code>DualList component</code> to add
                pre-selected.
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                Remove <code>canFilter</code> props to the <code>DualList component</code> to remove
                search option.
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
