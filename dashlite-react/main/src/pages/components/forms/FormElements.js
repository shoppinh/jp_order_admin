          ...
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                ...
                components for creating a wide variety of forms. Here’s a quick example to
                demonstrate form styles, so use these classes to opt into their customized displays.
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code>.form-control</code> className. Included are styles for general appearance,
                focus state, sizing, and more. Additional classes can be used to vary this layout on
                a per-form basis.
              </p>
            </BlockHeadContent>
          </BlockHead>
            ...
            <Row className='gy-4 align-center'>
              ...
              <Col lg='12'>
                <p className='text-soft'>
                  Use <code>.form-control-lg</code> or <code>.form-control-sm</code> with{' '}
                  <code>.form-control</code> for large or small input box.
                </p>
              </Col>
            </Row>
          </PreviewCard>
        ...
        <Block size='lg'>
          ...
          <PreviewCard>
            ...
            <Row className='gy-4'>
              ...
              <Col size='12'>
                <p className='text-soft'>
                  Use <code>.form-control-outlined</code> with <code>.form-control</code> for
                  outlined form element and replace <code>.form-label</code> with{' '}
                  <code>.form-label-outlined</code>, also place label after input/select element.
                </p>
              </Col>
            </Row>
          </PreviewCard>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                To create custom control, wrapped with <code className='code-tag'>&lt;div&gt;</code>{' '}
                each checkbox <code className='code-tag'>&lt;input&gt;</code> &amp;{' '}
                <code className='code-tag'>&lt;label&gt;</code> using <code>.custom-control</code>,{' '}
                <code>.custom-checkbox</code> classes.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
            <Row className='gy-4'>
              ...
              <Col xl='12'>
                <p className='text-soft'>
                  ...
                  <code>.custom-control-{`lg|sm`}</code> with <code>.custom-control</code>{' '}
                  className.
                </p>
              </Col>
            </Row>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                To create custom control, wrapped with <code className='code-tag'>&lt;div&gt;</code>{' '}
                each radio <code className='code-tag'>&lt;input&gt;</code> &amp;{' '}
                <code className='code-tag'>&lt;label&gt;</code> using <code>.custom-control</code>,{' '}
                <code>.custom-radio</code> classNames.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className='code-fnc'>checkbox</code> but uses the <code>.custom-switch</code>{' '}
                className to render a toggle switch.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code>import {`{RSelect}`} from "/components/Component.js"</code>. Visit the
