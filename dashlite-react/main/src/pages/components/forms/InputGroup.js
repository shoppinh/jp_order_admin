      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                Examples and usage guidelines for input group. Extend form controls by adding text,
                buttons, or button groups on either side of text inputs, custom selects, and custom
                file inputs.
              </p>
            </BlockDes>
          </BlockHeadContent>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                both sides of an input. We do not support multiple form-controls in a single input
                group and <code className='code-tag'>{`<label>`}</code>s must come outside the input
                group.
              </p>
            </BlockHeadContent>
          </BlockHead>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                will automatically resize—no need for repeating the form control size classes on
                each element.
              </p>
            </BlockHeadContent>
          </BlockHead>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>
                  Input groups include support for custom file inputs. Browser default versions of
