        ...
        <Block>
          <BlockHead size='lg' wide='sm'>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p className='lead'>
                  <strong>Softnio</strong> team design some beautiful and eyecatching custom icons
                  that helps much in your dashboard. All the icons are in SVG format so it never
                  blury in retina device and you can update color easily be edit SVG code.
                </p>
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
