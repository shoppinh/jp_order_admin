      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                Indicate the loading state of a component or page with Bootstrap spinners. To use
                it, import it such as <code>import {`{Spinner}`} from "reactstrap"</code>. Visit the{' '}
                <a
                  href={'https://reactstrap.github.io/?path=/docs/components-spinner--spinner'}
                  target='_blank'
                  rel='noreferrer'
                >
                  Reactstrap
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                The border spinner uses <code className='highlighter-rouge'>color</code> props for
                its <code className='highlighter-rouge'>border-color</code>, meaning you can
                customize the color with text color utilities. You can use any of our text color
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className='highlighter-rouge'>type="grow"</code> to make a smaller spinner
