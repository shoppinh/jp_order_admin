                    ...
                    <Collapse isOpen={collapse}>
                      ...
                      <div className='rating-card-description'>
                        ...
                        <p className='text-muted'>
                          ...
                          the card's content. Some quick example text to build on the card title
                          bulk.
                        </p>
                        <ul className='pt-2 gy-1'>
                          <li>
                ...
                <Card className='mt-4'>
                  ...
                  <div className='card-inner'>
                    <p className='text-soft'>
                      I've been using Dashlite for months now and with every update, update it's
                      just becoming more and more better it's just becoming better. Thank you for
                      such a great design touch. Further I definitely cooperate with your product .
                      Highly appriciate it. Really love it
                    </p>
                  </div>
                  <div className='card-inner border-top'>
                    <div className='d-flex'>
                      ...
                      <div className='fake-class'>
                        ...
                        <p className='text-soft'>
                          Time zone depend on your server time as we use that by default. So you
                          need to change that from your server. For data display issues, you may
                          send your website url so we can check what actually wrong.
                        </p>
                      </div>
                    </div>
                  </div>
