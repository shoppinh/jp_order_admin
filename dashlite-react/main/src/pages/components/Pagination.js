          ...
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                ...
                across multiple pages.To use it, import it such as{' '}
                <code>
                  import {`{Pagination, PaginationItem, PaginationLink}`} from "reactstrap"
                </code>
                . Visit the{' '}
                <a
                  href={
                    'https://reactstrap.github.io/?path=/docs/components-pagination--pagination'
                  }
                  target='_blank'
                  rel='noreferrer'
                >
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                The following example of basic pagination. Use pagination component from reactstrap
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Use <code>disabled</code> props in <code>PaginationItem</code> for links that appear
                un-clickable and <code>active</code> props in <code>PaginationItem</code> to
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Add <code>size="sm|md|lg"</code> props with <code>Pagination</code> component for
                additional sizes.
              </p>
            </BlockHeadContent>
          </BlockHead>
