      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                These examples for typography, including global settings, headings, body text,
                lists, and more. When more control is needed, check out the{' '}
          ...
          <PreviewTable>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <p>
                    Abbreviations have a <abbr title='hello'>default underline</abbr> and gain a
                    help cursor
                  </p>
                </td>
              </tr>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                For quoting blocks of content from another source within your document. Use
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Use <code>.list</code> class with <code className='code-tag'>{`<ul>`}</code> element
                to style basic listing. Also your can use <code>.list-checked</code> with{' '}
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className='code-fnc'>margin</code> with a combination of two classes,{' '}
