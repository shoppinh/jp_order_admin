      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                Examples for adding custom reactStrap tooltips with CSS and JavaScript using CSS3
                for animations. To use it, import it such as{' '}
                <code>import {`{Tooltip}`} from "reactstrap"</code>. Visit the{' '}
                <a
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Elements with the <code>disabled</code> props aren’t interactive, meaning users
                cannot focus, hover, or click them to trigger a tooltip (or popover). As a
                workaround, you’ll want to trigger the tooltip from a wrapper <code>div</code> or{' '}
