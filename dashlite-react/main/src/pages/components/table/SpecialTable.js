      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                <strong>Softnio Team</strong> understand the value of <strong>real case-use</strong>
                , so our team designed some large content base table which is{' '}
                <strong>well optimized</strong> and fit on every screen. It gives you extra ease on
                your project and surely you loved it.{' '}
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <strong className='text-primary'>invoice, payment history</strong> related
                transaction.
              </p>
            </BlockHeadContent>
          </BlockHead>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Add the <code>.is-compact</code> class with <code>.table-tranx</code> className to
                make compact version of table.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <Card className='card-bordered card-preview'>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                The following table can be use for{' '}
                <strong className='text-primary'>order history, invoice listing</strong> related
                transaction.
              </p>
            </BlockHeadContent>
          </BlockHead>
