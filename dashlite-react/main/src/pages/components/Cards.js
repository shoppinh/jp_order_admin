      ...
      <Content page='component'>
        <BlockHead size='lg' wide='sm'>
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className='lead'>
                Cards provide a flexible and extensible content container with multiple variants and
                options. To use it, import it such as{' '}
                <code>
                  import{' '}
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className='code-tag'>child props</code> inside <code>Card </code> <br />
                In the same way, links are added and placed next to each other by adding{' '}
                <code>CardLink</code> as a <code className='code-tag'>child props</code> inside{' '}
                <code>Card</code>.
              </p>
            </BlockHeadContent>
          </BlockHead>
        ...
        <Block size='lg'>
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Use <a href='/utlities/color'>colors utilities</a> to change the appearance of a
                card.
              </p>
            </BlockHeadContent>
          </BlockHead>
